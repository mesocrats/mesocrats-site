...
const TYPE_TO_PATHS: Record<string, string[]> = {
  ...
  page: ["/", "/party/mission", "/about/story", "/party/declaration", "/about/idea", "/about/leadership", "/about/faq", "/party/politics", "/platform/how-it-works", "/ccx/permanent-panels", "/ccx/permanent-panels/free-expression", "/ccx/permanent-panels/religion", "/party/the-corporation", "/research"],
