...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/convention`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${siteUrl}/convention/register`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${siteUrl}/convention/ideas`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
